...
// Listens for the custom event, dialogButtonClickedDetailEvent, to open a corresponding dialog box.
eventHub.addEventListener("dialogButtonClickedDetailEvent", event => {
